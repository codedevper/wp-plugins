...
<?php require plugin_dir_path(__FILE__) . 'views/components/head.php'; ?>

<body class="bg-background">
    <!-- ========== HEADER ========== -->
    <?php require plugin_dir_path(__FILE__) . 'views/components/header.php'; ?>
    <!-- ========== END HEADER ========== -->

    <!-- ========== MAIN SIDEBAR ========== -->
    <?php require plugin_dir_path(__FILE__) . 'views/components/main-sidebar.php'; ?>
    <!-- ========== END MAIN SIDEBAR ========== -->
    ...
    <script type="module" src="<?php echo PLUGIN_URL ?>inc/build/js/analytics-pages.js"></script>
</body>
