<!doctype html>
<html x-data lang="en" class="relative min-h-full h-full dark">
...
<body class="bg-black pb-15 flex h-full">
    <!-- ========== MAIN CONTENT ========== -->
    <main id="content"
        class="relative max-w-3xl px-4 sm:px-6 lg:px-8 flex flex-col justify-center sm:items-center mx-auto size-full before:absolute before:top-0 before:inset-s-1/2 before:bg-[url('https://preline.co/assets/svg/examples-dark/squared-bg-element.svg')] before:bg-no-repeat before:bg-top before:size-full before:-z-1 before:transform before:-translate-x-1/2">
        <div class="text-center py-8 px-4 sm:px-6 lg:px-8">
            <svg class="w-20 sm:w-28 h-auto mx-auto mb-4 sm:mb-8" width="116" height="41" viewBox="0 0 116 41"
                ...
                <path d="M1 33V20C1 13.3726 6.37258 8 13 8C19.6274 8 25 13.3726 25 20C25 26.6274 19.6274 32 13 32H12"
                    stroke="currentColor" stroke-width="2" class="stroke-white" />
                <path
                    d="M5 33V20.16C5 15.6534 8.58172 12 13 12C17.4183 12 21 15.6534 21 20.16C21 24.6666 17.4183 28.32 13 28.32H12"
                    stroke="currentColor" stroke-width="2" class="stroke-white" />
                <circle cx="13" cy="20.0215" r="5" fill="currentColor" class="fill-white" />
            </svg>
            ...
            <h2 class="mt-1 sm:mt-3 text-4xl font-bold text-white sm:text-6xl">
                <span
                    class="bg-clip-text bg-linear-to-tr from-blue-600 dark:from-blue-500 to-purple-400 text-transparent">
                    Upgrade to Pro
                </span>
            </h2>
            ...
            <form>
                <div class="mt-8 space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="hs-cover-with-gradient-form-name-1"
                                class="py-2.5 sm:py-3 ps-11 pe-4 block w-full bg-plain/10 border-white/20 text-white placeholder:text-white rounded-lg sm:text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11"
                                placeholder="Full name">
                            <div class="absolute inset-y-0 inset-s-0 flex items-center pointer-events-none z-20 ps-4">
                                <svg class="shrink-0 size-4 text-white/50" xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <div class="grid">
                        <button type="submit"
                            class="sm:p-4 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-plain/10 text-white hover:bg-plain/20 focus:outline-hidden focus:bg-plain/20 disabled:opacity-50 disabled:pointer-events-none">
                            Join the waitlist
    ...
    <footer class="absolute bottom-0 inset-x-0 text-center py-5">
        <div class="max-w-340 mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-sm text-white/50">© 2026 Preline Labs. A product of <a
                    class="text-white font-medium hover:text-white/80 focus:outline-hidden focus:text-white/80"
