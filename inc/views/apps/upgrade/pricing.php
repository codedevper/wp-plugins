        ...
        <nav
            ...
            <div id="hs-pro-an"
                ...
                <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-0">
                    <div
                        class="flex flex-col md:flex-row md:items-center md:justify-end gap-y-3 pt-6 pb-2 md:py-0 md:ps-7">
                        <a class="md:px-3 md:py-4 text-sm text-navbar-2-nav-foreground hover:text-navbar-2-nav-foreground-hover focus:outline-hidden focus:text-navbar-2-nav-foreground-focus"
                        ...
                        <div
                            ...
                            <!-- Dropdown Menu -->
                            <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] lg:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 relative w-full md:w-150 hidden z-10 top-full end-0 rounded-2xl bg-dropdown border-4 border-dropdown-line md:shadow-xl before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden mt-2 md:mt-0"
                                role="menu" aria-orientation="vertical" aria-labelledby="hs-pro-anpd">
                                <div class="flex flex-col gap-y-1">
                                    <!-- Grid -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
                                        <div
                                            class="p-5 md:min-h-50 flex flex-col justify-between bg-layer rounded-t-xl md:rounded-tr-none md:rounded-tl-xl">
                                            <!-- Heading -->
                                            <div class="mb-5">
                                                <a class="group flex items-center gap-x-2 font-medium text-sm text-navbar-2-nav-foreground hover:text-primary-hover focus:text-primary-focus focus:outline-hidden"
                                                    href="#">
                                                    Build
                                                    <span
                                                        class="ms-auto size-6 flex shrink-0 justify-center items-center bg-primary text-primary-foreground rounded-sm">
                                            ...
                                            <ul class="flex flex-col">
                                                <li
                                                    class="py-2 first:pt-0 last:pb-0 first:border-t-0 border-t border-line-1">
                                                    <a class="group flex items-center gap-x-2 font-medium text-sm text-navbar-2-nav-foreground hover:text-primary-hover focus:text-primary-focus focus:outline-hidden"
                                                        href="#">
                                        ...
                                        <div
                                            class="p-5 md:min-h-50 flex flex-col justify-between bg-layer md:rounded-tr-xl">
                                            <!-- Heading -->
                                            <div class="mb-5">
                                                <a class="group flex items-center gap-x-3 font-medium text-sm text-navbar-2-nav-foreground hover:text-primary-hover focus:text-primary-focus focus:outline-hidden"
                                                    href="#">
                                                    Resources
                                                    <span
                                                        class="ms-auto size-6 flex shrink-0 justify-center items-center bg-primary text-primary-foreground rounded-sm">
                                    ...
                                    <!-- Footer -->
                                    <div class="p-2 bg-layer rounded-b-xl">
                                        <div class="flex flex-wrap justify-between items-center gap-1">
                                            <a class="py-1.5 ps-3 pe-2 group flex items-center gap-x-1 font-medium text-sm text-foreground hover:text-primary-hover focus:text-primary-focus focus:outline-hidden"
                                                href="#">
                                            ...
                                            <a class="py-1.5 px-3 font-medium text-sm text-primary rounded-full hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus"
                                                href="#">
                                                Changelog
                                            </a>
                                        </div>
        ...
        <div class="overflow-hidden bg-background">
            <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
                <h1 class="font-semibold text-foreground text-5xl md:text-6xl">
                    <span class="text-primary">Preline Agency:</span> Transforming ideas into reality
                </h1>
        ...
        <div class="relative overflow-hidden pt-4 bg-background">
            ...
            <div class="relative z-10">
                <div class="max-w-5xl px-4 xl:px-0 mx-auto">
                    <div class="mb-4">
                        <h2 class="text-muted-foreground-1">Trusted by Open Source, enterprise, and more than 99,000 of
                            you</h2>
                    </div>
        ...
        <div class="bg-background bg-linear-to-t from-background-1 to-transparent">
            <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
                ...
                <div class="max-w-3xl mb-10 lg:mb-14">
                    <h2 class="text-foreground font-semibold text-2xl md:text-4xl md:leading-tight">Server status</h2>
                    <p class="mt-1 text-muted-foreground-1">Global brands see measurable success when they collaborate
                        with us. From higher conversion and payment approval rates to faster processing speeds. Discover
                    ...
                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-card first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none focus:outline-hidden before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-primary/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-primary/10 before:-z-1 before:opacity-0 hover:before:opacity-100 focus:before:opacity-100"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-5">
                                ...
                                <h3 class="mt-5 font-semibold text-xl text-foreground">Enhancement in Customer
                                    Engagement</h3>
                                <p class="mt-1 text-muted-foreground-1">With the aim of optimizing customer interactions
                                    and boosting brand loyalty, the team at Preline leveraged Mailchimp's powerful tools
                    ...
                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-card first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none focus:outline-hidden before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-primary/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-primary/10 before:-z-1 before:opacity-0 hover:before:opacity-100 focus:before:opacity-100"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-5">
                                ...
                                <p class="mt-1 text-muted-foreground-1">In collaboration with Shopify, Preline
                                    embarked&nbsp;on a mission to revolutionize the e-commerce experience for a
                                    fictitious fashion brand, 'StyleAura'.</p>
                            </div>
                        </div>
                    ...
                    <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-card first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none last:before:rounded-b-xl lg:first:before:rounded-s-xl lg:last:before:rounded-e-xl lg:last:before:rounded-bl-none focus:outline-hidden before:absolute before:inset-0 before:bg-linear-to-b hover:before:from-transparent hover:before:via-transparent hover:before:to-primary/10 before:via-80% focus:before:from-transparent focus:before:via-transparent focus:before:to-primary/10 before:-z-1 before:opacity-0 hover:before:opacity-100 focus:before:opacity-100"
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mt-5">
                                ...
                                <p class="mt-1 text-muted-foreground-1">With the goal of accelerating project delivery
                                    and enhancing collaboration among development teams, Preline leveraged GitLab's
        ...
        <div class="bg-background">
            <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
                ...
                <div class="max-w-3xl mb-10 lg:mb-14">
                    ...
                    <p class="mt-1 text-muted-foreground-1">With over 30 awards, and achievements, we proudly
                        demonstrate our unwavering dedication to excellence and client success.</p>
                </div>
                <!-- End Title -->
                            ...
                            <footer class="mt-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-4 md:ms-0">
                                        ...
                                        <div class="text-xs text-muted-foreground-1">Director Payments & Risk | Airbnb
                                        </div>
                                    </div>
                                </div>
                            </footer>
                    ...
                    <div class="p-4 lg:p-8 bg-linear-to-bl from-layer via-background to-background-1 rounded-xl">
                        <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                            ...
                            <div
                                ...
                                <svg class="shrink-0 size-6 sm:size-8 text-primary mx-auto"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
        ...
        <div class="bg-background">
            ...
            <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
                ...
                <div class="max-w-3xl mb-10 lg:mb-14">
                    ...
                    <p class="mt-1 text-muted-foreground-1">This profound insight guides our comprehensive strategy —
                        from meticulous research and strategic planning to the seamless execution of brand development
            ...
            <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
                  ...
                  autofill:pb-2" placeholder="Name">
                                    <label for="hs-tac-input-name" class="absolute top-0 start-0 p-3 sm:p-4 h-full text-muted-foreground-1 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                    peer-focus:text-xs
                  ...
                  autofill:pb-2" placeholder="Email">
                                    <label for="hs-tac-input-email" class="absolute top-0 start-0 p-3 sm:p-4 h-full text-muted-foreground-1 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                    peer-focus:text-xs
                    peer-focus:-translate-y-1.5
                    peer-focus:text-muted-foreground-1
                    peer-not-placeholder-shown:text-xs
                  ...
                  autofill:pb-2" placeholder="Company">
                                    <label for="hs-tac-input-company" class="absolute top-0 start-0 p-3 sm:p-4 h-full text-muted-foreground-1 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                    peer-focus:text-xs
                    peer-focus:-translate-y-1.5
                    peer-focus:text-muted-foreground-1
                    peer-not-placeholder-shown:text-xs
                  ...
                  autofill:pb-2" placeholder="Phone">
                                    <label for="hs-tac-input-phone" class="absolute top-0 start-0 p-3 sm:p-4 h-full text-muted-foreground-1 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                    peer-focus:text-xs
                    peer-focus:-translate-y-1.5
                    peer-focus:text-muted-foreground-1
                    peer-not-placeholder-shown:text-xs
                  ...
                  autofill:pb-2" placeholder="This is a textarea placeholder" data-hs-textarea-auto-height></textarea>
                                    <label for="hs-tac-message" class="absolute top-0 start-0 p-3 sm:p-4 h-full text-muted-foreground-1 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                    peer-focus:text-xs
                    peer-focus:-translate-y-1.5
                    peer-focus:text-muted-foreground-1
                    peer-not-placeholder-shown:text-xs
                    ...
                    <div class="space-y-14">
                        ...
                        <div class="flex gap-x-5">
                            ...
                            <div class="grow">
                                ...
                                <p class="mt-1 text-muted-foreground-1">We're thrilled to announce that we're expanding
                                    our team and looking for talented individuals like you to join us.</p>
                                <p class="mt-2">
