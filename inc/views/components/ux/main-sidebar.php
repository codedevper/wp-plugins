...
<div id="hs-pro-sidebar" class="hs-overlay [--body-scroll:true] lg:[--overlay-backdrop:false] [--is-layout-affect:true] [--opened:lg] [--auto-close:lg] hs-overlay-open:translate-x-0 lg:hs-overlay-layout-open:translate-x-0 -translate-x-full transition-all duration-300 transform w-60 hidden fixed inset-y-0 z-60 inset-s-0 bg-gray-100 dark:bg-neutral-900 lg:block lg:-translate-x-full lg:inset-e-auto lg:bottom-0" role="dialog" tabindex="-1" aria-label="Sidebar">
    <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
        ...
        <nav class="p-3 size-full flex flex-col overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            ...
            <button type="button" class="p-1.5 ps-2.5 w-full inline-flex items-center gap-x-2 text-sm rounded-lg bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 text-gray-600 dark:text-neutral-300 shadow-xs focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-pro-cmsssm" data-hs-overlay="#hs-pro-cmsssm">
                Search
                <span class="ms-auto flex items-center gap-x-1 py-px px-1.5 border border-gray-200 dark:border-neutral-700 rounded-md">
            ...
            <div class="pt-3 mt-3 flex flex-col border-t border-gray-200 dark:border-neutral-800 first:border-t-0 first:pt-0 first:mt-0">
                ...
                <ul class="flex flex-col gap-y-1">
                    <li>
                        <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-200 dark:hover:bg-neutral-800 focus:outline-hidden focus:bg-gray-200 dark:focus:bg-neutral-800"
            ...
            <div class="pt-3 mt-3 flex flex-col border-t border-gray-200 dark:border-neutral-800 first:border-t-0 first:pt-0 first:mt-0">
                ...
                <ul class="flex flex-col gap-y-1">
                    <li>
                        <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-200 dark:hover:bg-neutral-800 focus:outline-hidden focus:bg-gray-200 dark:focus:bg-neutral-800"
                            href="/server/analytics/visitors">
                            Top Visitors
                        </a>
                    </li>
                    <li>
                        <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-gray-800 dark:text-neutral-200 rounded-lg hover:bg-gray-200 dark:hover:bg-neutral-800 focus:outline-hidden focus:bg-gray-200 dark:focus:bg-neutral-800"
                            href="/server/analytics/authors">
                            Top Authors
                        </a>
                    </li>
                </ul>
            ...
            <div class="pt-3 mt-3 lg:hidden flex flex-col border-t border-gray-200 dark:border-neutral-800 first:border-t-0 first:pt-0 first:mt-0">
                <span class="block ps-2.5 mb-2 font-medium text-xs uppercase text-gray-500 dark:text-neutral-400">
                    Others
                </span>
